...
namespace Kinspeed\Schools\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(SchoolSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(SchoolSetup::ENTITY_TYPE_CODE . '_eav_attribute')],
