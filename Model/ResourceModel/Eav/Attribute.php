...
namespace Kinspeed\Schools\Model\ResourceModel\Eav;

use Kinspeed\Schools\Setup\SchoolSetup;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Kinspeed_School';
     ...
     * @var string
     */
    protected $_eventPrefix = SchoolSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Kinspeed\Schools\Model\ResourceModel\Attribute');
    }
