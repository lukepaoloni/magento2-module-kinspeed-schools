    ...
    function($) {        
        ...
        return {
            ...
            search : function(map, coords, latLng, config) {                        
                ...
                $(".map-search__results").append("<span class='results-word'>Closest schools:</span><br />");
                ...
                for (i = 0; i < markers.length; i++) { 
                    ...
                    if (distance < config.radius) {
                        ...
                        var contentToAppend = "<div class='results-content' data-miles='"+school_distance+"' data-marker='"+markers[i].record_id+"'><p class='results-title'>"+markers[i].global_name+"</p>";
